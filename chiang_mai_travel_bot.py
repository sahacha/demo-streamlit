...
groq_api_key = "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"  # ตัวอย่าง API key (ในการใช้งานจริงควรใช้วิธีที่ปลอดภัยกว่า)

# Sidebar
with st.sidebar:
    st.title("เที่ยวเชียงใหม่ AI")
    st.markdown("---")
